...
export function DriveExplorer(){
  ...
  const filtered=useMemo(()=>{
    ...
    return candidates.filter(d=>!excludedPropellants.has(d.propellant)&&!excludedFamilies.has(familyOf(d))&&!excludedSubtypes.has(subtypeKey(d))&&(!n||`${d.friendlyName} ${d.driveClassification} ${d.requiredPowerPlant} ${d.propellant} ${majorityCompositionSearch(d)}`.toLowerCase().includes(n)))
