...
export function DriveExplorer(){
  ...
  const labels=showNames?placeLabels(plotPoints,new Set(selected),chart,readableText?11:9):new Map<string,LabelPlacement>();
