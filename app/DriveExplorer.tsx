...
export function DriveExplorer(){
  ...
  const filtered=useMemo(()=>{
    ...
    return candidates.filter(d=>(family==="All families"||familyOf(d)===family)&&(!n||`${d.friendlyName} ${d.driveClassification} ${d.requiredPowerPlant} ${d.propellant}`.toLowerCase().includes(n)))
  },[drives,family,maxOnly,query]);
